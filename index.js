...
bot.on('ready', () => {
    ...
    function changing_status() {
      let status = ["「👮」Protège "+bot.guilds.size+"s. Anti-Raid ®『🚫』 ", "/help /invite", "Crée par _ClesiriusPE _「🎄」", "Joyeux Noël「🎄」", "「👮」Bot H24 Online", "#Go80servs", "「💪」On compte sur vous", "「👮」Protège "+bot.users.size+"Users."]
