...
if(message.content === prefix + "invite") {
	...
	.addField("InviteBot", ('[CLIQUEICI](https://discordbots.org/bot/511104745096609792)') , true)
	.setFooter("SecurityProtect®/!\『🚫』", bot.user.displayAvatarURL)
        .setTimestamp()
...
if(message.content.startsWith(prefix + "kick")) {
    ...
    if(message.content.startsWith(prefix + "ban")) {
        ...
        ban.ban().then(member => {
            message.channel.send(`${member.author.tag} est ban par ${message.author.username} !`)
        }
