...
bot.on('ready', () => {
    ...
    function changing_status() {
      let status = ["[👮]Protège "+bot.guilds.size+"s.", "[🔗] /help", "[🎊] Happy 2019! ", "[📆]On est le 31 Déc", "[🚨]Bot H24 Online", "[🌐]#Go100servs", "[💪]On compte sur vous", "[🚔]Protéction Actif.", "[💾]13 Commandes", "[📩]#SaveYourInternet"]
