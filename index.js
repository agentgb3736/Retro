...
bot.on('ready', () => {
    ...
    function changing_status() {
      let status = ["「👮」Protège "+bot.guilds.size+" serveurs ", "/help /invite", "Crée par _ClesiriusPE _「🎄」", "Joyeux Noël「🎄」", "「👮」17 065 " client.users.size +" users protégés", "#Go80servs", "「💪」On compte sur vous"]
