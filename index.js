...
bot.on('ready', () => {
    ...
    function changing_status() {
      let status = ["「👮」Protège "+bot.guilds.size+"s. Anti-Raid ®『🚫』 ", "/help & /invite", "Crée par _ClesiriusPE _「🎄」", "Joyeux Noël「🎄」", "「🎄」On est le 24 Décembre", "「👮」Bot H24 Online", "#Go90servs", "「💪」On compte sur vous", "「👮」Protéction Actif.", "「⚠」Maintenance le 25/12"]
...
bot.on('message', message => { 
    ...
    if(message.content === "Bonsoir"){
        message.reply("Bonsoir ta journée c'est bien passé ? ");
    ...
    console.log('Le bot dit joyeux noël');
    }
...
if(message.content === prefix + "partners") {
    ...
    var partner_embed = new Discord.RichEmbed()
     ...
     .addField("NoraVia V1", ('[Lien du Serveur](https://discord.gg/GTgHXd)') , true)
