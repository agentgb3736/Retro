...
bot.on('ready', () => {
    ...
    function changing_status() {
      let status = ['「👮」Protège' + bot.guilds.size's. I SP®『🚫』Anti-Raid 🚨", "/help /invite", "Crée par _ClesiriusPE _「🎄」", "Joyeux Noël「🎄」", "「👮」77 111 users protégés", "#Go80servs", "「💪」On compte sur vous"]
