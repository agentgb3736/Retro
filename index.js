...
bot.user.setActivity("[/help] I SP®『🚫』3 servs", {type:"STREAMING"});    
});
...
if(message.content.startsWith(prefix + "say")){
	...
	message.channel.send(text)
      ...
      if (message.content.startsWith(prefix + "vcs")) {
        ...
        .setFooter("SecurityProtect®/!\『🚫』", bot.user.displayAvatarURL)       .setTimestamp()
...
   .setFooter("SecurityProtect®/!\『🚫』", bot.user.displayAvatarURL)rURL)       .setTimestamp()
